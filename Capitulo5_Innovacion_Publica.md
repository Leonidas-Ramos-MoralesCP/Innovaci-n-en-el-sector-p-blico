...
![Crime trends](media/image1.png)

**Ejemplo 2: Visualización Comparativa**
![Comparative data](media/image2.png)

**Ejemplo 3: Desempeño en Educación por Género, Sector y Área (2016-2023)**
![Education data](media/image3.png)

**Ejemplo 4: Mortalidad Infantil en Perú (2002-2022)**
![Infant mortality](media/image4.png)

### Recursos Recomendados

Para explorar más tipos de visualización de datos:

- [ThoughtSpot - Tipos de gráficos y visualizaciones](https://www.thoughtspot.com/data-trends/data-visualization/types-of-charts-graphs)
- [Datylon - Ejemplos de tipos de gráficos](https://www.datylon.com/blog/types-of-charts-graphs-examples-data-visualization)
...
![Storyworld process steps](media/image5.png)
...
![Actor map example](media/image8.png)
...
![Actor mapping process](media/image9.png)
...
![Actor network case study](media/image10.png)
...
[Análisis de Redes - Ciencia de Datos](https://bookdown.org/keilor_rojas/CienciaDatos/an%C3%A1lisis-de-redes.html)
...
Para más información sobre 6 tipos diferentes de mapeo de procesos, consulte:
[Figma - Qué es el mapeo de procesos](https://www.figma.com/resource-library/what-is-process-mapping/)
...
![Process mapping example](media/image11.png)
...
[Coursera - Creando User Journey Maps](https://www.coursera.org/mx/articles/creating-user-journey-maps-a-guide)
...
![Spoken map example](media/image13.png)
...
![Adult senior case study](media/image14.jpeg)
...
Aquí encontrará una introducción a la estadística espacial:
[SEIO - Una introducción a la estadística espacial](https://www.seio.es/beio/una-introduccion-a-la-estadistica-espacial/)
