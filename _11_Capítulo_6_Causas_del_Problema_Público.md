...
![Diagrama: Los tres elementos de la causalidad](media/imagen1.gif)
...
![Ejemplo: Diagrama de causa-efecto para educación de baja calidad](media/imagen2.gif)
...
![Ejemplo: Diagrama de Ishikawa para inseguridad, limpieza y caos vehicular en Lima](media/imagen4.gif)

![Diagrama completado sobre inseguridad en Lima](media/imagen5.gif)
...
![Diagrama de causas de violencia hacia adultos mayores en Independencia](media/imagen6.gif)
